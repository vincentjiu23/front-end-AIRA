    ...
    <div className="flex flex-col min-h-screen bg-white">
      <main className="flex flex-col items-center px-6 py-10 gap-6 flex-1">
        ...
        <div
          ...
          className="w-full max-w-xl h-48 border-2 border-dashed border-gray-400 rounded-lg flex items-center justify-center px-4 text-gray-500 text-center cursor-pointer hover:border-blue-500 transition"
        >
          {selectedFile ? (
...
export default UploadPrognosis;
